...
import TableLayout from '../components/HomeLayout/TableLayout';
import CardLayout from '../components/HomeLayout/CardLayout';
...
const Home = () => {
  ...
  return (
    <div className='p-4'>
      ...
      {loading ? <Spinner/> : showType==='table' ? (<TableLayout books={books}/>) : 
      (<CardLayout books={books}/>)
      }
    </div>
  )
}
